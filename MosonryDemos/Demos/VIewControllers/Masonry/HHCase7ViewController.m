...
@interface HHCase7ViewController ()<UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate>
...
@implementation HHCase7ViewController
...
- (void)initView {
    ...
    [_parallaxHeaderView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        //1.把parallaxHeaderView 的 height MASConstraint 赋值给self.parallaxHeaderHeightConstraint
        //2.然后通过KVO赋值
